                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-dark">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT document.doc_id,document.name,document.location,document.datetime,project.name,employee.name FROM `document` INNER JOIN project on document.proj_id=project.proj_id INNER JOIN employee ON document.emp_id=employee.emp_id WHERE employee.email='$user'";
                ...
                <form action="include/adddocument.php" method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="currentDateTime" name="currentDateTime"
                                readonly>
                            ...
                            <script>
                                document.addEventListener("DOMContentLoaded", function () {
                                    ...
                                    document.getElementById('displayDateTime').value = formattedDateTime;
                                });
                            </script>
                        </div>
                        <div class="form-group">
                            <label for="leader">Project Name</label>
                            <select name="proj" class="form-select form-control" aria-label=".form-select-lg example">
                        ...
                        <div class="form-group">
                            <label for="leader">Employee ID</label>

                            <?php
                            $sql = "SELECT employee.emp_id,employee.name FROM `employee` WHERE employee.email='$user'";
                            if ($result = mysqli_query($conn, $sql)) {
                                if (mysqli_num_rows($result) > 0) {
                                    for ($i = 0; $i <= 29; $i++) {
                                        $row = mysqli_fetch_array($result);
                                        if ($row !== null) {
                                            ?>
                                            <input type="text" class="form-control" name="emp" value="<?php echo $row[0]; ?>" readonly>
                                            <?php
                                        }
                                    }
                                }
