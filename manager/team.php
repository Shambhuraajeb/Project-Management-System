                    ...
                    <table class="table table-bordered table-dark">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Team Member Email ID</th>
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT team.team_id, team.team_name, employee_manager.name AS manager_name, employee_manager.email AS manager_email, employee.name AS team_member_name, employee.email AS team_member_email, team_leader.name AS team_leader_name FROM team INNER JOIN team_member ON team.team_id = team_member.team_id INNER JOIN employee AS employee_manager ON team.team_leader = employee_manager.emp_id INNER JOIN employee ON team_member.emp_id = employee.emp_id INNER JOIN employee AS team_leader ON team.team_leader = team_leader.emp_id WHERE employee_manager.email='$user'";
